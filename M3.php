  ...
  <div class="container">
    ...
    <div class="gallery">
      <div class="main-image">
        <img id="mainImage" src="https://images.pexels.com/photos/3251406/pexels-photo-3251406.jpeg" onclick="syncThumbnail()" />
      </div>
    </div>

    <!-- Product Info -->
    <div class="info">
      <div class="title">Graphic Hoodie </div>
      <div class="subtitle">Men's Collection</div>
      <div class="price">MRP: ₹1200.00</div>
