...
<body>
    <a href="s.php" style="margin: 20px; display: inline-block; text-decoration: none;">
  ...
  <div class="container">
    ...
    <div class="gallery">
      <div class="main-image">
        <img id="mainImage" src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/27443692/2024/12/6/2148e1e4-af7f-45e9-a6c2-501c743209471733477391151-Azira-Checked-Cotton-Empire-Puff-Sleeve-Layered-Fit--Flare-M-1.jpg"onclick="syncThumbnail()" />
      </div>
    </div>

    <!-- Product Info -->
    <div class="info">
      <div class="title">Fflirtygo Fleece Skirt</div>
      <div class="subtitle">Summer Dress</div>
