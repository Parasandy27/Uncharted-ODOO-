...
<body>
    <a href="xl.php" style="margin: 20px; display: inline-block; text-decoration: none;">
  ...
  <div class="container">
    ...
    <div class="gallery">
      <div class="main-image">
        <img id="mainImage" src="https://nobero.com/cdn/shop/files/white_855177b5-5621-4a4b-a0d1-9060b89a6a69.jpg?v=1711979035"onclick="syncThumbnail()" />
      </div>
    </div>

    <!-- Product Info -->
    <div class="info">
      <div class="title">Men's T-Shirt</div>
      <div class="subtitle">Summer Dress</div>
      <div class="price">MRP: ₹1090.00</div>
