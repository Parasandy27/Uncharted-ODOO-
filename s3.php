  ...
  <div class="container">
    ...
    <div class="gallery">
      <div class="main-image">
        <img id="mainImage" src="https://myraymond.com/cdn/shop/files/CMSS30011-B3-1.jpg?v=1725608561"onclick="syncThumbnail()" />
      </div>
    </div>

    <!-- Product Info -->
    <div class="info">
      <div class="title">Men's Shirt</div>
      <div class="subtitle">Summer Dress</div>
      <div class="price">MRP: ₹1395.00</div>
