...
<body>
    <a href="L.php" style="margin: 20px; display: inline-block; text-decoration: none;">
  ...
  <div class="container">
    ...
    <div class="gallery">
      <div class="main-image">
        <img id="mainImage" src="https://images.pexels.com/photos/5709905/pexels-photo-5709905.jpeg" onclick="syncThumbnail()" />
      </div>
    </div>

    <!-- Product Info -->
    <div class="info">
      <div class="title">Knitted Sweater</div>
      <div class="subtitle">Women Winter Collection</div>
      <div class="price">MRP: ₹900.00</div>
